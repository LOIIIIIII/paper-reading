...
新论文网页版见 [不可观测状态追踪](docs/unobserved-state/can-video-world-models-track-unobserved-world-states.html)；[论文原文](https://arxiv.org/html/2608.30692) 提供方法与 Figure 4/5 的核对依据。网站由 GitHub Pages 从 `docs/` 发布，原有图片仍保留在 `docs/images/`。
